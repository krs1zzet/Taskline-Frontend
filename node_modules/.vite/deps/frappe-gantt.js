...
var B = class {
  ...
  bind_bar_events() {
    ...
    if (p.on(this.$svg, "mousemove", ".bar-wrapper, .handle", (g) => {
      this.bar_being_dragged === false && Math.abs((g.offsetX || g.layerX) - l) > 10 && (this.bar_being_dragged = true);
    }), p.on(this.$svg, "mousedown", ".bar-wrapper, .handle", (g, _) => {
      const c = p.closest(".bar-wrapper", _);
      _.classList.contains("left") ? (s = true, _.classList.add("visible")) : _.classList.contains("right") ? (r = true, _.classList.add("visible")) : _.classList.contains("bar-wrapper") && (t = true), this.popup && this.popup.hide(), e = g.offsetX || g.layerX, a = c.getAttribute("data-id");
      let u;
      ...
      p.on(this.$container, "mousewheel", (_) => {
        ...
        if (!g && _.currentTarget.scrollLeft <= c) {
          ...
          g = true, this.gantt_start = d.add(
            this.gantt_start,
            -this.config.extend_by_units,
            this.config.unit
          ), this.setup_date_values(), this.render(), _.currentTarget.scrollLeft = u + this.config.column_width * this.config.extend_by_units, setTimeout(() => g = false, 300);
        }
        if (!g && _.currentTarget.scrollWidth - (_.currentTarget.scrollLeft + _.currentTarget.clientWidth) <= c) {
          let u = _.currentTarget.scrollLeft;
          g = true, this.gantt_end = d.add(
            this.gantt_end,
            this.config.extend_by_units,
            this.config.unit
          ), this.setup_date_values(), this.render(), _.currentTarget.scrollLeft = u, setTimeout(() => g = false, 300);
        }
      });
    }
    p.on(this.$container, "scroll", (g) => {
      ...
      var g, _, c;
      t = false, s = false, r = false, (c = (_ = (g = this.$container.querySelector(".visible")) == null ? void 0 : g.classList) == null ? void 0 : _.remove) == null || c.call(_, "visible");
